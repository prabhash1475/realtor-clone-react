...
export default function SignUp() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      // here we make a copy of our
      //  formData and delete the password from it
      const formDataCopy = { ...formData };
      delete formDataCopy.password;

      // get the time stamp frome firebase
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-12">
          <form onSubmit={onSubmit}>
            <input
              className="mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-400 rounded"
              type="text"
              id="name"
              value={name}
              onChange={onChange}
            ...
            <div className="relative mb-6">
              <input
                className="w-full mb-6 px-4 py-2 text-xl text-gray-700 bg-white border-gray-400 rounded"
            ...
            <button
             ...
             px-7 py-4
              text-white text-sm font-medium uppercase rounded 
              mt-6 shadow-md
